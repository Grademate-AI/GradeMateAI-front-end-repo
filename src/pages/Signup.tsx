...
export const Signup: FC = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#071025] via-[#07101a] to-[#0b122d] text-white font-sans">
      <div className="bg-[#0c1324] p-10 rounded-2xl shadow-2xl w-full max-w-md">
        <h1 className="text-3xl font-bold mb-6 text-center glow-neon">Create Account</h1>
        <form className="flex flex-col gap-4">
          ...
          />
          <select
            className="p-3 rounded-xl bg-[#1a1f3a] border border-gray-600 text-white focus:outline-none focus:border-blue-500"
          >
